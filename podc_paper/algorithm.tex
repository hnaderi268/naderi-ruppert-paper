...
Refer to Figure \ref{implicit} for an example showing how the tree in Figure \ref{tournament} would actually be represented, and Figure \ref{object-fields} for the definitions of the fields of blocks and tree nodes.
