...
\State \tt{dir.blocks[h\sub{dir}].super.CAS(null, h)}
\State \tt{dir.head.CAS(h\sub{dir}, h\sub{dir}+1)}
\EndIf
...
\State \tt{n.blocks[h].super.\Call{CAS}{null, hp}} \label{setSuper1}
\State \tt{\head.\Call{CAS}{h, h+1}} 
