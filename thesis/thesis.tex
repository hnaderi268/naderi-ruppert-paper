...
\If{\tt{ root.blocks[b-1].\size}\tt{ + root.blocks[b].num\sub{enq} - i $<$ 0}} \cmt{Check if the queue is empty.}
\State \Return \tt{null} \label{checkEmpty}
\Else
