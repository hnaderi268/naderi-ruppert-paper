...
In Section \ref{sec::tracingCorrect} we show that the \op{getEnqueue} and \op{indexDequeue}
...
\begin{eqnarray*}
\var{num\sub{enq}} 
&=& \var{v}.\fld{left.blocks}[new.\eleft].\fld{sum\sub{enq}} + \var{v}.\fld{right.blocks}[new.\eright].\fld{sum\sub{enq}} - \var{v}.\fld{blocks}[h-1].\fld{sum\sub{enq}} \\
&=& \var{v}.\fld{left.blocks}[new.\eleft].\fld{sum\sub{enq}} + \var{v}.\fld{right.blocks}[new.\eright].\fld{sum\sub{enq}} \\
&&\mbox{ }- \var{v}.\fld{left.blocks}[\var{v}.\fld{blocks}[h-1].\eleft].\fld{sum\sub{enq}} - \var{v}.\fld{right.blocks}[\var{v}.\fld{blocks}[h-1].\eright].\fld{sum\sub{enq}}
\end{eqnarray*}
