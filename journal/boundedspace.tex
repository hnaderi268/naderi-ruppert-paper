...
polynomial in $p$ and $q$, while ensuring the (amortized) step complexity is still polylogarithmic. We replace the \fld{blocks} array in each node by a red-black tree (RBT)
