...
to omit polylogarithmic factors; see Appendix \ref{sec::GCanalysis} for precise bounds.}
Since all processes may run GC,
a total of $\tilde{O}(G)$ steps is spent on a GC phase.
There are at least $G$ operations between two GC phases,  so
