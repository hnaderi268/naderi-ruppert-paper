...
\here{Update this parag after code is finalized--it has changed since I wrote this parag}
...
it also updates \var{last} if the computed response is \nl.
...
\Function{boolean}{Refresh}{\typ{Node} \var{v}}
    ...
    \Else  
		...
		\State \var{result} \assign \Call{CAS}{\var{v}.\fld{blocks}, $T$, $T'$}\label{casGC}
		\State \Call{SetSuper}{$v$, $T'$}
		}
...
\Function{RBT}{AddBlock}{\typ{Node} \var{v}, \typ{RBT} \var{T}, \typ{Block} \var{B}}
    ...
    \If{\var{B}.\fld{index} is a multiple of $G$}
        ...
        \State $s \assign \Call{SplitBlock}{v}.\var{index}$\label{callSplitBlock}
        \State \Call{Help}{}
...
\Function{void}{SetSuper}{\typ{Node} \var{v}, \typ{RBT} $T$} 
	...
	\State $\var{vLast} \assign \Call{MaxBlock}{T}$
	\If{$v\neq \var{root}$}	
		\State \var{sup} \assign\ \Call{MaxBlock}{\var{v}.\fld{parent.blocks}}.\fld{index}
		\State \Call{CAS}{\var{vLast}.\fld{super}, \nl, \var{sup}}
	\EndIf
	\ForEach{\fld{dir} in \{\fld{left}, \fld{right}\}} \label{startHelpChild1GC}
    	\State $\var{childLast} \assign\ \Call{MaxBlock}{\var{v}.\fld{dir}.\fld{blocks}}$
		\State $\Call{CAS}{\var{childLast}.\fld{super}, \nl, \var{vLast}.\fld{index}}$
...
\Function{Block}{SplitBlock}{\typ{Node} v}
	...
	\EndIf
	\State \linecomment If $B$ was already discarded, use leftmost block instead
