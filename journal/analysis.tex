...
The following lemma helps bound the \rev{number of steps \op{GetEnqueue} takes}.
...
\rev{The bounds refer to the size of the queue when certain operations are linearized,
