...
Invariant \ref{lem::sum} allows us to prove that every block a \op{Refresh} installs contains at least one operation.
...
\here{cref doesn't seem to be working (it calls everything a theorem)}
...
\begin{eqnarray*}
\var{num\sub{enq}}
&=&  \var{v}.\fld{left.blocks}[new.\eleft].\fld{sum\sub{enq}} \\
