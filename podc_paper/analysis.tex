...
A \op{Refresh} does at most 7 \op{CAS} steps: one in line \ref{cas} and two from each \op{Advance} in line \ref{helpAdvance} or~\ref{advance}.
\end{proof}
...
The following lemma is useful in bounding the time for \op{GetEnqueue}
