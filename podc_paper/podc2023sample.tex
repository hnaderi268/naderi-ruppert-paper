...
\title{A Wait-free Queue with Poly-logarithmic Worst-caseStep Complexity}
...
double-blind initial submission of a full-length technical paper and more --- all by
...
The template style used for PODC 2023 submissions is {\verb|acmsmall|}.
