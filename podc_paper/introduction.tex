...
Our queue uses a tournament tree where each process has its own leaf.\here{Is "tournament tree" the right word here?  Maybe call it a merge tree? or a linearization tree?}
