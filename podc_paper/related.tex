...
To avoid the CAS retry problem, concurrent operations try to claim spots in an array using fetch-and-increment instructions.
...
\paragraph{Universal Constructions and Other Poly-log Time Data Structures}
...
Need to discuss Fatourou and Kallimanis TCS 55(3)
Fatourou and Kallimanis \cite{FK14} gave a universal construction based on fetch-and-add and CAS
and used it to implement a queue....
