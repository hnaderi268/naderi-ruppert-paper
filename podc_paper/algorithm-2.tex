...
\Function{void}{Append}{\typ{Block} \var{B}} 
    ...
    \State \gc{\var{leaf}.\fld{blocks}.\Call{TryInsert}{\var{B}}\label{appendLeafGC}}
...
\gc{    
	...
	\EndFor 
	\State \Call{Help}{}
	\State \Call{Discard}{$\var{root}, \var{max}-2$}
	\EndIf
	\State
}
    ...
    \EndIf
    \State \gc{\var{result} \assign\ \var{v}.\fld{blocks}.\Call{TryInsert}{\var{new}} \label{casGC}}
    \State \var{\Call{Advance}{\var{v, h}}}\label{advanceGC}
...
\Function{Block}{CreateBlock}{\typ{Node} \var{v}, \typ{int} \var{i}} 
    ...
    \State \gc{\var{new}.\fld{index} \assign \var{h}}
...
\Function{element}{FindResponse}{\typ{int} \var{b}, \typ{int} \var{i}}
    ...
    \If{$\var{root}.\fld{blocks}[\var{b}-1].\size + \var{num\sub{enq}} < \var{i}$}\label{checkEmptyGC}
        \State \gc{\var{last[this process id]} \assign\ \var{b}}
    ...
    \Else \ \linecomment{response is the \var{e}th enqueue in the root}
        ...
        \State \gc{\var{e} \assign\ \Call{GetEnqueue}{\var{root}, $b_e$, $i_e$}}\label{findAnswerGC}
        \State \gc{\var{last[this process id]} \assign\ $b_e$}
        \State \gc{\Return{\var{e}}}
    \EndIf
...
\Function{void}{Help}{}
    ...
    \For{\bf{each} $\ell$ in $\var{leaf}[1..k]$}
...
\Function{void}{Discard}{\typ{Node} \var{v}, \typ{int} \var{t}}
    ...
    \State \var{t\sub{left}} = \var{v}.\fld{blocks}[\var{t}].\eleft
    \State \var{t\sub{right}} = \var{v}.\fld{blocks}[\var{t}].\eright
	\For{\var{j} \assign 1 to $p$}
        \State $T \assign \var{v}.\fld{blocks}$
        \State $T'  \assign \Call{Split}{T,t}$ \Comment{$T'$ is the root of new RBT containing $T$'s blocks with $\var{index} > t$}
