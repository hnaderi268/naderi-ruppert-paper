...
\Function{Object}{Dequeue()}{} 
    ...
    \State \Call{Append}{\var{B}}\Comment{\rev{append \op{Dequeue} to \var{leaf}.\fld{blocks} and propagate to root}}\label{deqAppend}
    ...
    \State \Return{\Call{FindResponse}{\var{b, i}}}\Comment{\rev{find response \op{Dequeue} should return}}\label{deqRest}
\EndFunction{Dequeue}
