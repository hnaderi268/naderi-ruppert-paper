...
Finally, when linearizing the operations propagated to the root, we must
choose how to order operations within a block.  Any ordering within a block would work, since all operations
in a block are concurrent with one another.  We choose to put
