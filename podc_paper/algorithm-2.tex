...
\end{algorithmic}
\end{minipage}
\caption{Queue implementation.\label{pseudocode1GC}}
\end{figure}
...
\Function{void}{Discard}{\typ{Node} \var{v}, \typ{int} \var{i}}
    \State $T \assign \var{v}.\fld{blocks}$
    \State $\langle T_1, T_2\rangle \assign \Call{Split}{T,i}$
    \State \Call{CAS}{\var{v}.\fld{blocks}, $T$, $T_2$}
    \If{\var{v} is an internal \typ{Node}}
        \State \Call{Discard}{\var{v}.\fld{left}, \var{v}.\fld{blocks}[\var{i}].\eleft}
        \State \Call{Discard}{\var{v}.\fld{right}, \var{v}.\fld{blocks}[\var{i}].\eright}
    \EndIf
\EndFunction{Discard}
}
\end{algorithmic}
\caption{\label{pseudocode2GC}Queue implementation, continued. \here{Would this routine be simpler to write if i parameter was the rank within whole node rather than within the block?}}
\end{figure}
