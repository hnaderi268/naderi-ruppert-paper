...
\begin{itemize}
\item \typ{Node} \var{root} \Comment{root of binary tree of \typ{Node}s with one leaf per process}
\end{itemize}
...
\Function{void}{Propagate}{\typ{Node} \var{v}} \com\ propagate blocks from \var{v}'s children to root
    \If{{\keywordfont not} \Call{Refresh}{\var{v}}} \label{firstRefresh}  \hfill \com\ double refresh
