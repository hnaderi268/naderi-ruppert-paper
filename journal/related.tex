...
\HERE{discuss \cite{ACH18} who seem to have showed that strongly linearizable (define) queue is impossible using weak primitives; can also mention that HW22 observed that the MS queue is not strongly linearizable but can easily be made so}
