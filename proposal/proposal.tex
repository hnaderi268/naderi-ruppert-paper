...
In this work, we are going to introduce a novel lock-free queue. Linearizable lock-free data structures are the current standard requirements for designing distributed algorithms. All lock-free queues in the literature yet have a common problem in their worst case. Our algorithm solves this problem, performing better than them.
