...
\begin{figure}[t]
  ...
  \caption{Baskets queue idea. There is a mechanism in the algorithm that orders the operations in a basket by the order of which \texttt{CAS}es first successfully.}
\end{figure}
