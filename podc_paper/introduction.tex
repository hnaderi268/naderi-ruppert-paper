...
For the space-bounded implementation, we unlink unneeded memory from our data structure, but 
leave the problem of reclaiming that memory up to a garbage collector (such as the one Java provides).
